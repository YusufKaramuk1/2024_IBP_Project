						...
						<ul>
							...
							<li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown">Login</a>
                                <ul class="dropdown-menu">
                                    <li><a href="student/login.php" style="color: black !important;">Student Login</a></li>
                                    <li><a href="teacher/login.php" style="color: black !important;">Teacher Login</a></li>
                                </ul>
                            </li>
		...
		<div class="slide-carousel owl-carousel">
			<div class="item" style="background-image:url(dist/img/3.jpg);">
				...
				<div class="text">
					...
					<div class="this-item">
						<h3>Empowering Knowledge, One Book at a Time.</h3>
					</div>
					<div class="this-item">
